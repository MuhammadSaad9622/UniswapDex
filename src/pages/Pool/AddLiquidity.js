...
//         const estimatedGasLimit = 100000000; 
      ...
      <OversizedPanel hideBottom>
        <SummaryPanel>
          ...
          <ExchangeRateWrapper>
            ...
            <span>
              {exchangeETHBalance && exchangeTokenBalance
                ? `${amountFormatter(exchangeETHBalance, 18, 4)} BSTC + ${amountFormatter(
                    exchangeTokenBalance,
                    decimals,
                    Math.min(4, decimals)
                  )} ${symbol}`
          ...
          <ExchangeRateWrapper>
            ...
            <span>
              {ethShare && tokenShare
                ? `${amountFormatter(ethShare, 18, 4)} BSTC + ${amountFormatter(
                    tokenShare,
                    decimals,
                    Math.min(4, decimals)
                  )} ${symbol}`
